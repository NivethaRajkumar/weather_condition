...
//creating a base(container, head, row)
...
response.then((data)=>data.json()).then((result)=>{
    ...
    buttons.forEach((btn,index)=>{   
        btn.addEventListener("click",()=>{
            //latling spliting for weather api
            ...
            let weatherApi=fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=0bcbcba2ec071f853fbaccac14369d40`)
